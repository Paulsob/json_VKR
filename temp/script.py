...
try:
    ...
    workbook = openpyxl.load_workbook("../data/data.xlsx", data_only=False)
except FileNotFoundError:
    print("❌ Ошибка: Файл data.xlsx не найден в текущей директории.")
    exit(1)
...
# Обрабатываем листы начиная с 3-го (индекс 2)
for sheet_name in all_sheets[2:]:
    ...
    output_path = os.path.join("../output", f"{filename}.xlsx")
